      ...
      <section className="relative h-[600px] w-full bg-[#0e7490] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1366px] px-4 h-full flex flex-col justify-center">
          <div className="animate-fade-in-up max-w-3xl">
            ...
            <p className="text-cyan-50/90 text-lg md:text-xl max-w-2xl mb-10 leading-relaxed font-medium text-justify">
                From routine screenings to complex maxillofacial surgeries. Delivering pain-free, precision care with the latest technology for a healthier smile.
            </p>
        ...
        <div className="mx-auto w-full max-w-[1366px] px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {features.map((item, idx) => (
              <div key={idx} className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md border-t-4 border-cyan-500 hover:border-[#0f172a] transition-all duration-300 group flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-cyan-50 flex items-center justify-center flex-shrink-0 text-cyan-700 group-hover:bg-cyan-500 group-hover:text-white transition-all">
