...
const doctors = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1559839734-2b71ef197ec2?auto=format&fit=crop&q=80&w=800",
  },
];
            ...
            <div className="lg:col-span-4 flex justify-center">
              <div className="sticky top-24 w-full h-fit flex flex-col gap-10">
                ...
                <div className="bg-[#0b1c43] p-10 rounded-3xl text-white shadow-2xl relative overflow-hidden flex flex-col items-center text-center">
                  ...
                  <svg
                    className="w-12 h-12 text-blue-400 mb-6"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
            ...
            {[
              {
                ...
                items: ["Histopathology", "Cytopathology", "FNAC Services"],
              },
              {
                title: "Biochemistry",
                items: ["Electrolytes", "Toxicology", "Enzyme Analysis"],
              },
              {
                title: "Genetic Testing",
                items: ["Molecular Testing", "Karyotyping", "DNA Analysis"],
              },
            ].map((box, i) => (
              <div
                key={i}
              ...
              >
                ...
                <h4 className="text-2xl font-black text-[#0b1c43] mb-6 font-heading uppercase tracking-tight">
                  {box.title}
                </h4>
