      ...
      <section className="py-12 bg-gray-50/30">
        <div className="mx-auto w-full max-w-[1366px] px-4">
            ...
            {[
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-1 group-hover:text-teal-600 transition-colors uppercase tracking-tight">{card.title}</h3>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="w-full lg:w-1/2">
                <div className="relative">
                     <span className="text-teal-600 font-bold tracking-[0.2em] text-xs uppercase mb-3 block">Patient Centered Care</span>
              ...
              <ul className="space-y-4 mb-8">
                {[
                  ...
                  'Same-day appointments for urgent cases'
                    ...
                    <li key={i} className="flex items-center gap-3 text-gray-800 font-bold text-base md:text-lg">
           ...
           <div className="mx-auto w-full max-w-[1366px] px-4">
                    ...
                    <div className="relative h-[400px] rounded-3xl overflow-hidden shadow-2xl group border-[12px] border-white">
                         ...
                         />
                          ...
                          <div className="absolute bottom-8 left-8 text-white">
                              ...
                              <p className="text-[10px] font-bold uppercase tracking-[0.3em] opacity-80">MRI Precision</p>
                          </div>
                    </div>
                 </div>
                 <div className="w-full md:w-1/2 order-1 md:order-2">
                     <span className="text-teal-600 font-bold tracking-[0.3em] text-xs uppercase mb-3 block">Innovation</span>
                     <h3 className="text-3xl md:text-4xl font-black font-heading text-gray-900 mb-6 uppercase tracking-tight">Advanced Technology</h3>
              ...
              <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
                 <div className="w-full md:w-1/2">
                     <span className="text-teal-600 font-bold tracking-[0.3em] text-xs uppercase mb-3 block">Precision</span>
                     <h3 className="text-3xl md:text-4xl font-black font-heading text-gray-900 mb-6 uppercase tracking-tight">Accurate Radiology Reporting</h3>
                     <p className="text-gray-700 mb-6 text-base md:text-lg font-bold text-justify leading-relaxed">
                  ...
                  <div className="w-full md:w-1/2">
                    <div className="relative h-[400px] rounded-3xl overflow-hidden shadow-2xl group border-[12px] border-white">
                         ...
                         <div className="absolute bottom-8 right-8 text-white text-right">
                              ...
                              <p className="text-[10px] font-bold uppercase tracking-[0.3em] opacity-80">Expert Reporting</p>
                          </div>
                    </div>
                 </div>
              </div>
      ...
      <section className="bg-[#00A99D] py-24 text-white">
           <div className="mx-auto w-full max-w-[1366px] px-4">
               <div className="text-center mb-16 max-w-2xl mx-auto">
                   <span className="text-teal-100 font-bold tracking-[0.4em] text-[10px] uppercase mb-4 block">Our Expertise</span>
                   <h2 className="text-4xl md:text-5xl font-black text-white font-heading mb-6 uppercase tracking-tight">World Class Imaging</h2>
                   <p className="text-teal-50 text-lg opacity-90 font-bold">Comprehensive radiology services covering everything from routine X-rays to advanced interventional procedures.</p>
               </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-12">
                   {[
                       ...
                       <div key={idx} className="flex items-start gap-4 border-b-2 border-teal-400/30 pb-8 group cursor-pointer hover:border-white transition-all">
                           ...
                           <div className="flex-1">
                               <h4 className="text-2xl font-black mb-1 group-hover:translate-x-2 transition-transform font-heading uppercase tracking-tight">{service.title}</h4>
                               <p className="text-teal-50 text-xs opacity-70 font-bold uppercase tracking-widest">Specialized Service</p>
                           </div>
                           <svg className="w-6 h-6 opacity-0 group-hover:opacity-100 transition-all transform group-hover:translate-x-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 12h14M12 5l7 7-7 7" /></svg>
                       </div>
                   ))}
               </div>
           </div>
      ...
      <section className="bg-slate-900 py-16 text-white">
        <div className="mx-auto w-full max-w-[1366px] px-6 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex items-center gap-6">
              ...
              <div>
                  <p className="text-teal-400 font-bold uppercase tracking-widest text-xs mb-1">Emergency Radiology</p>
                  <p className="text-2xl font-black font-heading tracking-tight uppercase">24/7 Helpline Number</p>
              </div>
          </div>
          <div className="flex items-center gap-4 text-3xl md:text-4xl font-black font-heading">
                <a href="tel:+917800001895" className="hover:text-teal-400 transition-colors tracking-tighter text-[#E85222]">+91-7800001895</a>
                <span className="opacity-30">/</span>
                <a href="tel:+917800001896" className="hover:text-teal-400 transition-colors tracking-tighter text-[#E85222]">96</a>
          </div>
        </div>
      </section>
    </main>
