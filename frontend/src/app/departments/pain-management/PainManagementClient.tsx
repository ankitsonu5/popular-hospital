...
const trigeminalSection: ContentItem[] = [
  ...
  {
    title: "What kind of the treatment of OA Knee/Shoulder offered in Pain Clinic?",
...
const prpSection: ContentItem[] = [
  {
    title: "Platelet Rich Therapy(PRP) Therapy What is PRP Therapy? How it is useful in Pain Management?",
  ...
  {
    title: "Could PRP/RF Neurotomy is an alternative to Knee Replacement Surgery?",
...
const ContentBlock = ({ title, text, bullets }: { title: string; text?: string; bullets?: string[] }) => (
  <div className="mb-10 group">
    ...
    {text && (
        <p className="text-gray-700 text-base md:text-lg leading-relaxed text-justify font-medium mb-4 whitespace-pre-line">
            {text}
        </p>
    )}
    {bullets && (
        <ul className="space-y-3 pl-2">
            {bullets.map((bullet, idx) => (
                <li key={idx} className="flex items-start gap-3 text-gray-700 font-medium text-base md:text-lg">
                    <span className="text-gray-900 mt-1.5 font-bold flex-shrink-0 text-xl leading-none">•</span>
                    <span>{bullet}</span>
                </li>
            ))}
        </ul>
        ...
        <div className="mx-auto w-full max-w-[1366px] px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-8">
              ...
              <div className="mb-16">
                <SectionHeader title="Platelet Rich" highlight="Therapy(PRP) Therapy" />
