        ...
        <div className="mx-auto w-full max-w-[1366px] px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
                ...
                <a href="tel:+917800001895" className="bg-white/10 backdrop-blur-sm text-white px-8 py-3.5 rounded-full font-bold border border-white/20 hover:bg-white/20 transition-all flex items-center gap-2">
