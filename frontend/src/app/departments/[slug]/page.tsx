...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://popularhospital.in/departments/${slug}`,
    },
  };
}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-sm border border-slate-100">
              <h2 className="text-3xl font-bold text-[#0b1c43] mb-6 font-heading">
                Overview
              </h2>
              <div className="prose prose-slate max-w-none">
                ...
                <h3 className="text-2xl font-bold text-[#0b1c43] mb-6 font-heading">
