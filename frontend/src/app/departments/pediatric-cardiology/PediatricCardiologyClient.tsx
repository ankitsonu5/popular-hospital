      ...
      <section className="py-16 xl:py-10 2xl:py-20">
        <div className="mx-auto w-full max-w-5xl xl:max-w-[1280px] 2xl:max-w-7xl px-6">
            ...
            <div className="lg:col-span-8 space-y-8 text-gray-700">
              <div>
                <h2 className="text-2xl 2xl:text-3xl font-bold text-[#0b1c43] mb-4">
                  Purvanchal’s First Full-time Pediatric Cardiologist &
                  Intensivist
                </h2>
                <div className="space-y-4 text-base 2xl:text-lg leading-relaxed text-justify">
                  <p>
                    ...
                    Department is dedicated to providing advanced,
                    compassionate, and child-friendly care to Fragile hearts of
              ...
              <div>
                <p className="font-bold text-[#284a91] uppercase tracking-wide mb-4 text-sm 2xl:text-base">
          ...
          <div className="mt-16 xl:mt-24 space-y-16 xl:space-y-20">
            <div>
              <SectionHeader
                title="Pediatric Heart Conditions"
                highlight="We Treat"
              />
              <p className="mb-4 text-base xl:text-[15px] 2xl:text-lg">
                Our department specialises in diagnosing and managing a wide
                range of heart conditions in children, including:
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 xl:gap-6">
                ...
                <div className="bg-white rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-100 p-5 xl:p-6 flex flex-col hover:translate-y-[-4px] transition-all duration-300">
                  <div className="flex items-center gap-3 xl:gap-4 mb-4 xl:mb-5">
                    <div className="w-10 h-10 xl:w-12 xl:h-12 rounded-xl bg-blue-50 flex items-center justify-center shrink-0">
                      <svg
                        className="w-5 h-5 xl:w-6 xl:h-6 text-blue-600"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                ...
                <div className="bg-white rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-100 p-5 xl:p-6 flex flex-col hover:translate-y-[-4px] transition-all duration-300">
                  <div className="flex items-center gap-3 xl:gap-4 mb-4 xl:mb-5">
                    <div className="w-10 h-10 xl:w-12 xl:h-12 rounded-xl bg-[#fff2ed] flex items-center justify-center shrink-0">
                      <svg
                        className="w-5 h-5 xl:w-6 xl:h-6 text-[#E85222]"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth="2"
                          d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1.01.707.293l5.414 5.414a1 1.01.293.707V19a2 2 2 0 01-2 2z"
                        ></path>
                      </svg>
                    </div>
                    <h4 className="font-bold text-[#0b1c43] text-[17px] xl:text-[18px] leading-snug">
                ...
                <div className="bg-white rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-100 p-5 xl:p-6 hover:translate-y-[-4px] transition-all duration-300">
                  <div className="flex items-center gap-3 xl:gap-4 mb-2 xl:mb-3">
                    <div className="w-9 h-9 xl:w-10 xl:h-10 rounded-full bg-indigo-50 flex items-center justify-center shrink-0">
                      <svg
                        className="w-4 h-4 xl:w-5 xl:h-5 text-indigo-600"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <h4 className="font-bold text-[#0b1c43] text-[16px] xl:text-[17px]">
                      Cardiac Rhythm Disorder
                    </h4>
                  </div>
                  <p className="text-gray-600 pl-12 xl:pl-14 text-[14px] xl:text-[15px] font-medium">
                ...
                <div className="bg-white rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-100 p-5 xl:p-6 flex flex-row items-center gap-3 xl:gap-4 hover:translate-y-[-4px] transition-all duration-300">
                  <div className="w-9 h-9 xl:w-10 xl:h-10 rounded-full bg-red-50 flex items-center justify-center shrink-0">
                    <svg
                      className="w-4 h-4 xl:w-5 xl:h-5 text-red-500"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <div className="bg-white rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-100 p-5 xl:p-6 flex flex-row items-center gap-3 xl:gap-4 hover:translate-y-[-4px] transition-all duration-300">
                  <div className="w-9 h-9 xl:w-10 xl:h-10 rounded-full bg-purple-50 flex items-center justify-center shrink-0">
                    <svg
                      className="w-4 h-4 xl:w-5 xl:h-5 text-purple-600"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                <div className="bg-white rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-gray-100 p-5 xl:p-6 flex flex-row items-center gap-3 xl:gap-4 hover:translate-y-[-4px] transition-all duration-300">
                  <div className="w-9 h-9 xl:w-10 xl:h-10 rounded-full bg-teal-50 flex items-center justify-center shrink-0">
                    <svg
                      className="w-4 h-4 xl:w-5 xl:h-5 text-teal-600"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
            ...
            <div>
              <SectionHeader
                title="When should you meet a"
                highlight="pediatric cardiologist?"
              />
              <p className="mb-5 font-semibold text-[17px] xl:text-[18px] text-[#0b1c43]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 xl:gap-5">
                {[
                  ...
                  <div
                    key={idx}
                    className="flex items-center gap-3 bg-white p-4 xl:p-5 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow"
                  >
                    <div className="w-8 h-8 xl:w-10 xl:h-10 rounded-full bg-blue-50 flex items-center justify-center shrink-0">
                      <svg
                        className="w-4 h-4 xl:w-5 xl:h-5 text-blue-600"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <p className="text-[15px] xl:text-[16px] text-gray-700 font-medium">
                      {item}
                    </p>
                  </div>
                ))}
            ...
            <div>
              <SectionHeader
                title="Pediatric Cardiac Services"
                highlight="available at Popular Hospital"
              />
              <p className="mb-4 text-base xl:text-[15px] 2xl:text-lg">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                {[
                  ...
                  <li
                    key={idx}
                    className="flex items-center gap-3 bg-gray-50 p-3 rounded-lg border-l-4 border-blue-600"
                  >
            ...
            <div>
              <SectionHeader
                ...
                highlight="for Pediatric Cardiology?"
              />
