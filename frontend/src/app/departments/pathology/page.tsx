        ...
        <div className="mx-auto w-full max-w-[1366px] px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex flex-col items-start text-left">
                ...
                <h3 className="text-xl font-bold text-[#334155] mb-3 uppercase tracking-wide">Basic Health Check-up</h3>
                <p className="text-gray-500 mb-8 text-sm leading-relaxed max-w-md font-medium">
                    Our laboratory offers comprehensive health check-up packages designed for early detection and prevention.
                </p>
            ...
            <div className="lg:col-span-3 flex flex-col gap-10">
                {[
                    ...
                    <div key={idx} className="flex items-start gap-5 group">
                        ...
                        <div className="pt-1">
                            <h4 className="text-[#004d61] font-bold text-lg mb-1 font-heading uppercase tracking-tight">{feature.title}</h4>
                            <p className="text-gray-500 text-xs leading-relaxed max-w-[200px] font-medium">
                                Delivering accurate results with maximum efficiency and precision.
                            </p>
      ...
      <section className="bg-[#00A99D] py-24 text-white">
           <div className="mx-auto w-full max-w-[1366px] px-4">
               <div className="text-center mb-16 max-w-2xl mx-auto">
                   ...
                   <h2 className="text-4xl md:text-5xl font-bold text-white font-heading mb-6 uppercase tracking-tight">High Quality Test Services</h2>
                   <p className="text-teal-100 text-lg opacity-90 font-medium">Comprehensive diagnostic services covering everything from routine blood work to advanced genetic testing.</p>
               </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
                   {[
                       ...
                       <div key={idx} className="flex items-start gap-4 border-b border-teal-400/30 pb-6 group cursor-pointer hover:border-white transition-all">
                           ...
                           <div className="flex-1">
                               <h4 className="text-xl font-bold mb-1 group-hover:translate-x-1 transition-transform font-heading uppercase tracking-tight">{service.title}</h4>
                               <p className="text-teal-100 text-sm opacity-80 font-bold">Advanced comprehensive analysis</p>
                           </div>
                           <svg className="w-5 h-5 opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.3} d="M5 12h14M12 5l7 7-7 7" /></svg>
                       </div>
                   ))}
               </div>
           </div>
