        ...
        <div className="mx-auto w-full max-w-5xl 2xl:max-w-7xl px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-8">
              ...
              <div className="text-gray-700 space-y-6 mb-10 leading-relaxed text-[1.05rem] xl:text-[15px] 2xl:text-lg text-justify font-medium">
                <p>
                ...
                <div className="space-y-4">
                  <div className="bg-white p-6 rounded-xl border-l-4 border-blue-600 shadow-sm transition-all hover:shadow-md">
                    <h3 className="text-xl font-bold text-[#0b1c43] mb-2 font-heading uppercase tracking-tight">
                      Medical Oncology
                    </h3>
