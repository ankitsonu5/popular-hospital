...
const features = [
  {
    ...
    icon: "baby",
    desc: "Expert care for you and your baby.",
  },
  {
    title: "Advanced Laparoscopy",
    icon: "scope",
    desc: "Minimally invasive gynaecological surgeries.",
  },
  {
    title: "Cancer Screening",
    icon: "microscope",
    desc: "Screening for cervical & breast cancers.",
  },
  {
    title: "Family Planning",
    icon: "heart",
    desc: "Comprehensive reproductive health services.",
  },
];
...
const gynaecologyProcedures = [
  ...
  {
    text: "Gynaecological cancer screening – pap smear, CT Scan & MRL, tumour markers",
    type: "item",
  },
  {
              ...
              <div className="space-y-4 text-gray-800 text-base md:text-lg xl:text-[15px] 2xl:text-lg leading-relaxed mb-12 font-medium text-justify">
                ...
                <div className="bg-pink-50/50 p-6 rounded-xl border-l-4 border-pink-600">
                  <p>
                    ...
                    safe and well tested. The department also focuses on expert
                    counselling and quality care on matters related to
                    infertility management, family welfare, menopause
                    management, prenatal diagnosis, reconstructive surgery and
                    pelvic floor medicine.
                  </p>
                </div>
                <p>
                  The Dept. of Obs. & Gynae offers a comprehensive range of
                  inpatient and outpatient services span the need of women from
                  their teen years, through pregnancy to menopause and beyond.
                  Routine screening and check-ups including screening for
                  various cancers as well as diagnostic workups for specialized
      ...
      <section className="py-24 xl:py-12 2xl:py-24 bg-white border-b border-gray-50">
        <div className="mx-auto w-full max-w-5xl 2xl:max-w-7xl px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div
              className="lg:col-span-7 order-1 lg:order-2 relative rounded-3xl overflow-hidden shadow-2xl group bg-pink-50/10"
