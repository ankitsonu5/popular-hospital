            ...
            <div className="lg:col-span-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20 animate-fade-in">
                ...
                <div className="relative">
                  <div className="relative w-full aspect-[4/3] overflow-hidden shadow-2xl rounded-[30%_70%_70%_30%/30%_30%_70%_70%] scale-110">
                    <Image
                      src="/images/departments-images/nephrology_symptoms.png"
              ...
              {/* Professionals Section - Screenshot 2 Style */}
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start animate-fade-in pb-20">
                 <div className="lg:col-span-8">
                  <h2 className="text-3xl font-bold text-[#0b1c43] mb-12 font-heading leading-tight max-w-2xl">
                ...
                <div className="lg:col-span-4 relative flex justify-center pt-8">
                  <div className="relative w-full max-w-[320px] aspect-[1/1.2] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.1)] rounded-[70%_30%_30%_70%/70%_70%_30%_30%] transform translate-y-4">
                    <Image
                      src="/images/departments-images/nephrology_procedure.png"
