...
export default function AboutPage() {
  return (
    <div className="bg-white min-h-screen font-sans">
      {/* ─── Hero Section ─── */}
      <section className="relative bg-[#0b1c43] text-white overflow-hidden min-h-[150px] md:min-h-[200px] xl:min-h-[150px] flex flex-col justify-center py-8 md:py-10 xl:py-6 mt-[110px] md:mt-0">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-5xl xl:text-2xl font-bold text-white mb-2 md:mb-4 xl:mb-2 font-heading tracking-tight drop-shadow-lg uppercase">
            About Us
          </h1>
        </div>
      </section>

      <div className="py-20 sm:py-24 xl:py-12">
        <div className="container mx-auto px-6 max-w-[1366px] xl:max-w-5xl">
          {/* Top Section with Text & Image */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            {/* Left Side: Headings */}
            <div className="flex flex-col justify-center">
              <h2 className="flex items-center text-xl sm:text-2xl xl:text-lg font-black text-[#1e3a8a] mb-4 xl:mb-3 uppercase tracking-wider font-heading">
                <span className="mr-3 text-2xl xl:text-lg">🏥</span>
                WELCOME TO POPULAR HOSPITAL
              </h2>
              <p className="text-gray-900 font-bold italic text-lg sm:text-xl md:text-2xl xl:text-lg leading-relaxed font-heading">
                POPULAR HOSPITAL 
                <span className="font-semibold italic text-base md:text-lg xl:text-sm">
          ...
          <div className="space-y-6 max-w-5xl text-gray-600 text-[15px] sm:text-[17px] xl:text-[14px] leading-relaxed font-medium">
            <p>
