                ...
                <div className="space-y-4">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-bold text-gray-700 uppercase leading-tight mt-1">{chairmanData.subtitle}</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center shrink-0 shadow-sm">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-bold text-gray-700 uppercase leading-tight mt-1">{chairmanData.qualifications}</p>
                    </div>
                  </div>
                </div>
            </div>
