            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8">
              {paginatedItems.map((item, index) => (
                <div
                  ...
                  className="group relative cursor-pointer flex flex-col h-full bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border-2 border-[#1e3a8a]/5 hover:border-[#1e3a8a]/30"
                >
                  ...
                  {/* Content */}
                  <div className="p-5 border-l-4 border-teal-600 flex-1 flex flex-col bg-white">
                    ...
                    <h2 className="text-[15px] font-bold text-[#1e3a8a] leading-tight group-hover:text-teal-600 transition-colors line-clamp-3">
                      {item.title}
                    </h2>
                  </div>
                </div>
