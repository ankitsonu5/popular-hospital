  ...
  return (
    <div className="container-narrow py-10">
      ...
      <p className="mt-2 text-gray-600">
        Our OPD services are available across all branches. Book a slot online
        or walk in during OPD hours.
      </p>

      <section className="mt-10" aria-labelledby="opd-info">
        <h2 id="opd-info" className="text-xl font-semibold text-hospital-navy">
          OPD Services
        </h2>
      ...
      <section
        ...
        aria-labelledby="opd-timings"
      >
        <h2
          id="opd-timings"
          className="text-xl font-semibold text-hospital-navy"
        >
          OPD Timings
        </h2>
        <p className="mt-2 text-gray-600">
          Morning: 9:00 AM – 1:00 PM | Evening: 2:00 PM – 5:00 PM (Monday –
          Saturday)
        </p>
        <p className="mt-1 text-sm text-gray-500">
          Timings may vary by branch and doctor. Please check while booking.
        </p>
      </section>
