...
/** Safely coerce a value to a non-empty string, or return the fallback. */
...
export default async function DoctorPage({ params }: Props) {
  ...
  try {
    ...
    // Cleanup: remove trailing parenthetical (e.g. "(Cardiology)") from qualifications
    ...
    // Guard: ensure every branch has a valid schedule array
