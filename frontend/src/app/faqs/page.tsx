...
export const metadata: Metadata = {
  ...
  description: 'Find answers to common questions about Popular Hospital Varanasi, including appointments, emergency services, cashless facilities, and more.',
};
...
const faqs = [
  ...
  },
  {
    ...
    answer: "The hospital is located at Kakarmatta, near DLW Ground, Varanasi, Uttar Pradesh, 221004. It is well-connected and accessible from all major parts of the city."
  },
  {
    id: 9,
    question: "Is there a 24-hour pharmacy within the hospital?",
    answer: "Yes, an in-house pharmacy is available 24/7 to ensure that all necessary medications and surgical supplies are readily available for patients at any time."
  },
  {
    id: 10,
    question: "What are the rules and timings for patient visitors?",
    answer: "General ward visiting hours are 11:00 AM – 1:00 PM and 5:00 PM – 7:00 PM. Ward and ICU visits are strictly regulated to maintain a sterile environment and ensure patient safety."
  },
  {
    id: 11,
    question: "Does Popular Hospital have a dialysis center?",
    answer: "Yes, we have a state-of-the-art Dialysis Center providing 24/7 services for patients with chronic kidney diseases, supported by experienced nephrologists."
  },
  {
    id: 12,
    question: "Are preventive health checkup packages available?",
    answer: "We offer a variety of comprehensive preventive health checkup packages tailored for different age groups and lifestyles to ensure early detection and wellness."
  },
  {
    id: 13,
    question: "Do you provide assistance for international patients?",
    answer: "Yes, Popular Hospital has a dedicated international patient care cell that assists with appointments, travel, and accommodation for patients visiting from abroad."
  },
  {
    id: 14,
    question: "Is there a cafeteria or food service for attendants?",
    answer: "Yes, we have an in-house hygienic cafeteria that provides nutritious meals for both patients (as per diet) and their attendants."
  },
  {
    id: 15,
    question: "How can I obtain a copy of my medical records?",
    answer: "Medical records and discharge summaries can be obtained from the Medical Records Department (MRD) during office hours after completing the necessary formalities."
  }
];
      ...
      <div className="mx-auto max-w-[1366px] px-6 lg:px-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-gray-500 text-sm sm:text-lg leading-relaxed max-w-5xl">
            Explore detailed answers to commonly asked questions about healthcare services, specialist consultations, treatment processes, and patient care at Popular Hospital, one of India's leading multispeciality hospital networks.
          </p>
        </div>
        ...
        <div className="mt-24 bg-white rounded-[2rem] p-10 md:p-14 text-center border border-[#d0e3f0] shadow-xl relative overflow-hidden">
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-black text-[#1a3a5c] mb-6 font-heading">Still have more questions?</h2>
            <p className="text-gray-500 mb-10 text-xl max-w-3xl mx-auto leading-relaxed">Our clinical support team is available 24/7 to guide you through your medical journey.</p>
