...
const sitemapData = [
  ...
  },
  {
    ...
    links: [
      { name: "Laparoscopy & General Surgery", href: "/departments/general-surgery" },
      { name: "Obstetrics & Gynaecology", href: "/departments/gynaecology" },
      { name: "Pediatrics And Neonatology", href: "/departments/pediatrics" },
      { name: "Orthopedics & Joint Replacement", href: "/departments/orthopedics" },
      ...
      { name: "Dietetics & Nutrition", href: "/departments/dietetics-nutrition" },
           ...
           <div className="relative z-10">
              ...
              <p className="text-gray-300 text-lg mb-10 max-w-2xl mx-auto">
               ...
               <div className="flex flex-col sm:flex-row justify-center items-stretch sm:items-center gap-4 max-w-lg mx-auto">
                  <Link href="/book" className="px-6 py-3 sm:px-10 sm:py-4 bg-[#E85222] text-white rounded-2xl sm:rounded-full font-black hover:bg-[#d1451a] transition-all shadow-lg shadow-orange-900/40 uppercase tracking-widest text-xs sm:text-sm text-center">
                     Book Appointment
                  </Link>
                  <a href="tel:+917800001895" className="px-6 py-3 sm:px-10 sm:py-4 bg-white/10 backdrop-blur-md text-white border border-white/20 rounded-2xl sm:rounded-full font-black hover:bg-white/20 transition-all uppercase tracking-widest text-xs sm:text-sm text-center">
                     Call: +91 7800001895
                  </a>
                  <a href="tel:+917800001896" className="px-6 py-3 sm:px-10 sm:py-4 bg-white/10 backdrop-blur-md text-white border border-white/20 rounded-2xl sm:rounded-full font-black hover:bg-white/20 transition-all uppercase tracking-widest text-xs sm:text-sm text-center">
                     Call: +91 7800001896
                  </a>
               </div>
           </div>
