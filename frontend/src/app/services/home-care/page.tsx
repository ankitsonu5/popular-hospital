          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
            ...
            <div className="w-full lg:w-[60%] lg:pr-10">
              <p className="text-gray-600 leading-relaxed text-justify text-[1.05rem] mb-6">
                With the introduction of Home Care Services, Popular Hospital
                has focused on providing quality care at the comfort of your
                doorsteps with an aim to making healthcare more affordable as
                well as convenient to the consumer. Since it is known that many
                patients struggle to get to the hospitals, this initiative will
                make sure that the crucial medical services can be offered to as
                many individuals as possible, and they do not have to undergo
                the hassle of traveling regularly.
              </p>
              <p className="text-gray-600 leading-relaxed text-justify text-[1.05rem] mb-6">
                Our services include doctor consultations for expert medical
                advice, 24/7 nursing care for continuous monitoring,
                physiotherapy sessions to aid recovery and mobility, and blood
                sample collection at home for timely diagnosis. Additionally,
                our focus is to ensure a holistic approach to care.
              </p>
              <p className="text-gray-600 leading-relaxed text-justify text-[1.05rem] mb-6">
                This is not merely a service but rather, a genuine of Popular
                Hospital to offer caring health care beyond the four walls of a
                hospital. We expect to reduce the discomfort due to travelling,
                save time and provide a patient and family peace of mind by
                making professional medical support available at home.
              </p>
              <p className="text-gray-600 leading-relaxed text-justify text-[1.05rem] mb-12">
                When you seek the services of Home Care Services in Popular
                Hospital, you could rest assured that you will get high quality
                services, top notch medical assistance and even the feeling of
                personal care and attention, but where you feel most
                comfortable.
              </p>
              ...
              <div className="space-y-12">
                {/* 1 */}
                <div>
                  <h2 className="text-2xl lg:text-3xl font-black text-[#0b1c43] font-heading mb-4 leading-tight">
                    Doctor Consultation
                  </h2>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    {["Vaccination (Routine & Seasonal at home)"].map(
                      (item, id) => (
                        <li
                          key={id}
                          className="flex gap-3 text-gray-700 items-start"
