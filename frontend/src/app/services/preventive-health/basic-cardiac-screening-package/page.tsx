...
export const metadata: Metadata = {
  title: 'Basic Cardiac Screening Package | Preventive Health Check Up | Popular Hospital',
  description: 'Detailed information and items covered under the Basic Cardiac Screening Package.',
};

export default function BasicCardiacScreeningPackagePage() {
  const consultations = [
    'CARDIOLOGIST'
  ];

  const investigations = [
    'CBC', 'RANDOM BLOOD SUGAR', 'LIPID PROFILE', 'SERUM CREATININE',
    'BLOOD UREA', 'ECG', '2D ECHO'
  ];
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1366px] px-6">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4 font-heading tracking-tight">
              Basic Cardiac Screening Package
            </h1>
            <nav className="flex items-center text-sm md:text-base text-white/90 font-medium" aria-label="Breadcrumb">
              ...
              <span className="mx-2 text-red-600 font-bold">|</span>
              <span className="text-white">Basic Cardiac Screening Package</span>
            </nav>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto max-w-5xl px-4 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-center justify-between gap-10 mb-20">
            ...
            <div className="w-full md:w-[70%] bg-white rounded-[32px] shadow-[0_8px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex overflow-hidden group">
                <div className="w-[160px] sm:w-[220px] relative bg-[#f5f5f7] flex-shrink-0">
                    <Image
                        src="/images/health-packages/basic_cardiac_screening_package.jpg"
                        alt="Basic Cardiac Screening Package"
                        fill
          ...
          <div className="bg-[#fbfbfd] p-10 sm:p-14 rounded-[40px] border border-gray-100/50 shadow-sm">
             <div className='mb-10'><h2 className='text-[#1d1d1f] text-2xl font-bold tracking-tight mb-2'>BASIC CARDIAC SCREENING PACKAGE</h2><div className='w-12 h-1 bg-[#0066cc] rounded-full'></div></div>
