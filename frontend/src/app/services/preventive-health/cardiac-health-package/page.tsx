...
export const metadata: Metadata = {
  title: 'Cardiac Health Package | Preventive Health Check Up | Popular Hospital',
  description: 'Detailed information and items covered under the Cardiac Health package.',
};

export default function CardiacHealthPackagePage() {
  const consultations = [
    'CARDIOLOGIST', 'GENERAL PHYSICIAN', 'DIETICIAN'
  ];

  const investigations = [
    'CBC', 'BLOOD SUGAR FASTING', 'BLOOD SUGAR PP', 'LIPID PROFILE',
    'LIVER FUNCTON TEST', 'KIDNEY FUNCTION TEST', 'URINE (ROUTINE AND MICROSCOPY)', 'X RAY CHEST',
    'ECG', 'TMT', '2D ECHO'
  ];
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1366px] px-6">
          <div className="max-w-4xl">
            ...
            <nav className="flex items-center text-sm md:text-base text-white/90 font-medium" aria-label="Breadcrumb">
              ...
              <span className="mx-2 text-red-600 font-bold">|</span>
              <span className="text-white">Cardiac Health Package</span>
            </nav>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto max-w-5xl px-4 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-center justify-between gap-10 mb-20">
            ...
            <div className="w-full md:w-[70%] bg-white rounded-[32px] shadow-[0_8px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex overflow-hidden group">
                <div className="w-[160px] sm:w-[220px] relative bg-[#f5f5f7] flex-shrink-0">
                    <Image
                        src="/images/health-packages/cardiac_health_package.jpg"
                        alt="Cardiac Health Package"
                        fill
                ...
                <div className="p-10 flex flex-col justify-center flex-1">
                    <span className='text-[#bf4800] text-[11px] font-bold tracking-widest uppercase mb-2'>Recommended: 18-65 Yrs.</span><h2 className='text-[#1d1d1f] font-bold text-xl sm:text-2xl tracking-tight mb-4'>CARDIAC HEALTH PACKAGE</h2>
                    ...
                    <div className="text-gray-800 text-[15px] font-bold">
                        Package Price ₹ 10050.00
                    </div>
                    <div className="text-[#1a3a6b] text-[15px] font-bold mt-1">
                        After Discount Price ₹ 5499.00
                    </div>
                </div>
            </div>
          ...
          <div className="bg-[#fbfbfd] p-10 sm:p-14 rounded-[40px] border border-gray-100/50 shadow-sm">
             <div className='mb-10'><h2 className='text-[#1d1d1f] text-2xl font-bold tracking-tight mb-2'>CARDIAC HEALTH PACKAGE</h2><div className='w-12 h-1 bg-[#0066cc] rounded-full'></div></div>
