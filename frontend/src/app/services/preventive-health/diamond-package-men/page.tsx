...
export const metadata: Metadata = {
  title: 'Diamond Package Men | Preventive Health Check Up | Popular Hospital',
  description: 'Detailed information and items covered under the Diamond Package for Men.',
};

export default function DiamondPackageMenPage() {
  const consultations = [
  ...
  const investigations = [
    ...
    'HIV 1&2', 'HCV ANTIBODY', 'URINE ANALYSIS', 'STOOL TEST(ROUTINE AND MICRSCOPIC )',
    '', 'PSA TOTAL', 'USG WHOLE ABDOMEN', 'X RAY CHEST PA VIEW',
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1366px] px-6">
          <div className="max-w-4xl">
            ...
            <nav className="flex items-center text-sm md:text-base text-white/90 font-medium" aria-label="Breadcrumb">
              ...
              <span className="mx-2 text-red-600 font-bold">|</span>
              <span className="text-white">Diamond Package Men</span>
            </nav>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto max-w-5xl px-4 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-center justify-between gap-10 mb-20">
            ...
            <div className="w-full md:w-[70%] bg-white rounded-[32px] shadow-[0_8px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex overflow-hidden group">
                <div className="w-[160px] sm:w-[220px] relative bg-[#f5f5f7] flex-shrink-0">
                    <Image
                        src="/images/health-packages/diamond_package_men.jpg"
                        alt="Diamond Package Men"
                        fill
                ...
                <div className="p-10 flex flex-col justify-center flex-1">
                    <span className='text-[#bf4800] text-[12px] font-bold tracking-widest uppercase mb-3'>Recommended: 18-25 Yrs.</span><h2 className='text-[#1d1d1f] font-bold text-xl sm:text-2xl tracking-tight mb-4'>DIAMOND PACKAGE MEN</h2>
                    
                    <div className="text-gray-800 text-[15px] font-bold line-through">
                        Package Price ₹ 29090.00
                    </div>
                    <div className="text-[#1a3a6b] text-[15px] font-bold mt-1">
                        Discount Price ₹ 15999.00
                    </div>
                </div>
            </div>
          ...
          <div className="bg-[#fbfbfd] p-10 sm:p-14 rounded-[40px] border border-gray-100/50 shadow-sm">
             <div className='mb-10'><h2 className='text-[#1d1d1f] text-2xl font-bold tracking-tight mb-2'>DIAMOND PACKAGE-MEN</h2><div className='w-12 h-1 bg-[#0066cc] rounded-full'></div></div>
             ...
             <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    {investigations.map((item, id) => (
                        <div key={id} className="bg-white border border-gray-100/80 p-5 rounded-2xl text-[14px] text-[#1d1d1f] font-medium uppercase shadow-sm flex items-center gap-4 group/item hover:border-blue-100 transition-colors"><div className="w-2 h-2 rounded-full bg-blue-500/50 group-hover/item:bg-blue-500 transition-colors"></div>
                           {item}
                        </div>
                    ))}
                </div>
