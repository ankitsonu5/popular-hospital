             ...
             <div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-gray-200 border border-gray-200">
                    {investigations.map((item, id) => (
                        <div key={id} className="bg-[#f9fafb] border-white flex items-center justify-center p-3 text-center text-[10px] md:text-[11px] text-gray-700 font-medium uppercase hover:bg-white transition-colors h-14">
                           {item}
                        </div>
                    ))}
                </div>
