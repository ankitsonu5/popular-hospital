...
export const metadata: Metadata = {
  title: 'Diamond Package Women | Preventive Health Check Up | Popular Hospital',
  description: 'Detailed information and items covered under the Diamond Package for Women.',
};

export default function DiamondPackageWomenPage() {
  const consultations = [
    'GYNAECOLOGIST', 'CARDIOLOGIST', 'DENTAL', 'DIETICIAN',
    'ENT', 'GENERAL PHYSICIAN', 'OPHTHALMOLOGIST', 'PAIN SPECIALIST'
  ];

  const investigations = [
    'MER', 'COMPLETE HAEMOGRAM', 'BLOOD GROUP & Rh typing', 'BLOOD SUGAR FASTING',
    'BLOOD SUGAR PP', 'HBA1C', 'HOMOCYSTEINE', 'HbsAg',
    'CRP', 'TSH', 'LIPID PROFILE', 'LIVER FUNCTON TEST',
    'KIDNEY FUNCTION TEST', 'SERUM CALCIUM TOTAL', 'VITAMIN D3', 'VITAMIN B12<',
    '/li>', 'HIV 1&2', 'HCV ANTIBODY', 'URINE ANALYSIS',
    'STOOL TEST(ROUTINE AND MICRSCOPIC )', 'PAP SMEAR', 'USG WHOLE ABDOMEN', 'X RAY CHEST PA VIEW',
    'PFT (PULMONARY FUNCTION TEST)', 'ECG', 'TMT', 'DEXA (2 SITES)'
  ];
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1366px] px-6">
          <div className="max-w-4xl">
            ...
            <nav className="flex items-center text-sm md:text-base text-white/90 font-medium" aria-label="Breadcrumb">
              ...
              <span className="mx-2 text-red-600 font-bold">|</span>
              <span className="text-white">Diamond Package Women</span>
            </nav>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto max-w-5xl px-4 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-center justify-between gap-10 mb-20">
            ...
            <div className="w-full md:w-[70%] bg-white rounded-[32px] shadow-[0_8px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex overflow-hidden group">
                <div className="w-[160px] sm:w-[220px] relative bg-[#f5f5f7] flex-shrink-0">
                    <Image
                        src="/images/health-packages/diamond_package_women.jpg"
                        alt="Diamond Package Women"
                        fill
          ...
          <div className="bg-[#fbfbfd] p-10 sm:p-14 rounded-[40px] border border-gray-100/50 shadow-sm">
             <div className='mb-10'><h2 className='text-[#1d1d1f] text-2xl font-bold tracking-tight mb-2'>DIAMOND PACKAGE-WOMEN</h2><div className='w-12 h-1 bg-[#0066cc] rounded-full'></div></div>
             ...
             <div>
                ...
                {/* Last row items - X RAY MAMMOGRAPHY & 2D ECHO - center aligned */}
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-px bg-gray-200 border-x border-b border-gray-200">
                     <div className="hidden lg:block bg-transparent"></div>
                     <div className="bg-white border border-gray-100/80 p-5 rounded-2xl text-[14px] text-[#1d1d1f] font-medium uppercase shadow-sm flex items-center gap-4 group/item hover:border-blue-100 transition-colors"><div className="w-2.5 h-2.5 rounded-full bg-blue-400/40 group-hover/item:bg-blue-500 transition-colors"></div>X RAY MAMMOGRAPHY</div>
                     <div className="bg-white border border-gray-100/80 p-5 rounded-2xl text-[14px] text-[#1d1d1f] font-medium uppercase shadow-sm flex items-center gap-4 group/item hover:border-blue-100 transition-colors"><div className="w-2.5 h-2.5 rounded-full bg-blue-400/40 group-hover/item:bg-blue-500 transition-colors"></div>2D ECHO</div>
                     <div className="hidden lg:block bg-transparent"></div>
                </div>
             </div>
