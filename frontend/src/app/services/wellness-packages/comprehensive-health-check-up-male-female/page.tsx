...
export async function generateMetadata() {
  return generatePageMetadata("/services/wellness-packages/comprehensive-health-check-up-male-female", {
  title:
  ...
  alternates: {
    canonical: "https://www.popularhospital.in/services/wellness-packages/comprehensive-health-check-up-male-female",
  },
});
}
