...
export const metadata: Metadata = {
  title: 'Comprehensive Health Check Up (Male & Female) | Wellness Packages | Popular Hospital',
  description: 'Detailed information and items covered under the Comprehensive Health Check Up (Male & Female).',
};

export default function PackagePage() {
  const investigations = [
    'Complete Haemogram -CBC & ESR', 'Blood Group', 'Liver Function Test', 'Kidney Function Test', 'Lipid Profile', 'Blood Sugar Fasting', 'Glycosylated Haemoglobin (HbA1c)', 'Serum Phosphorous', 'Serum Calcium total', 'Urine Routine and Microscopy', 'CRP', 'Serum Uric Acid', 'Stool for occult Blood', 'TSH', 'T3', '25 Hydroxy Vitamin D-Total', 'PSA (for Males)', 'X-Ray Chest', 'Ultrasound whole abdomen', 'PFT', '2D-ECHO', 'CPK', 'Consultation- Physician', 'Cardiologist', 'Gen. Surgeon', 'Dental & Dietician'
  ];
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1366px] px-6">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4 font-heading tracking-tight">
              Comprehensive Health Check Up (Male & Female)
            </h1>
            <nav className="flex items-center text-sm md:text-base text-white/90 font-medium" aria-label="Breadcrumb">
              ...
              <span className="mx-2 text-red-600 font-bold">|</span>
              <span className="text-white">Comprehensive Health Check Up (Male & Female)</span>
            </nav>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-20">
            <div className="w-full md:w-[70%] bg-white rounded-[32px] shadow-[0_8px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex overflow-hidden group">
                ...
                <div className="p-10 flex flex-col justify-center flex-1">
                    <h2 className='text-[#1d1d1f] font-bold text-xl sm:text-2xl tracking-tight mb-4 uppercase'>Comprehensive Health Check Up (Male & Female)</h2>
