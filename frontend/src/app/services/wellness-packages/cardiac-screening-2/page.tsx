...
export const metadata: Metadata = {
  ...
  description: 'Detailed information and items covered under the Cardiac Screening 2.',
};

export default function PackagePage() {
  const investigations = [
    'Total Cholesterol', 'HDL, LDL VLDL', 'Triglycerides', 'FBS (Fasting Blood Sugar)', 'S. Creatinine', 'S. Bilirubin, SGOT, SGPT', 'HbA1C', 'ECG', 'Cardiac Opinion'
  ];
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-20">
            <div className="w-full md:w-[70%] bg-white rounded-[32px] shadow-[0_8px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex overflow-hidden group">
                ...
                <div className="p-10 flex flex-col justify-center flex-1">
                    <h2 className='text-[#1d1d1f] font-bold text-xl sm:text-2xl tracking-tight mb-4 uppercase'>Cardiac Screening 2</h2>
