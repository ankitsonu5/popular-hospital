...
export const metadata: Metadata = {
  title: 'Executive Health Check Up (Male) | Wellness Packages | Popular Hospital',
  description: 'Detailed information and items covered under the Executive Health Check Up (Male).',
};

export default function PackagePage() {
  const investigations = [
    'CBC', 'Blood Group', 'Serum Creatinine', 'Blood Sugar Fasting', 'Glycosylated Haemoglobin (HbA1c)', 'X-Ray Chest', 'ECG', 'Physician Consultation', 'Dietician Consultation'
  ];
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1366px] px-6">
          <div className="max-w-4xl">
            ...
            <nav className="flex items-center text-sm md:text-base text-white/90 font-medium" aria-label="Breadcrumb">
              ...
              <span className="mx-2 text-red-600 font-bold">|</span>
              <span className="text-white">Executive Health Check Up (Male)</span>
            </nav>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-20">
            <div className="w-full md:w-[70%] bg-white rounded-[32px] shadow-[0_8px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex overflow-hidden group">
                ...
                <div className="p-10 flex flex-col justify-center flex-1">
                    <h2 className='text-[#1d1d1f] font-bold text-xl sm:text-2xl tracking-tight mb-4 uppercase'>Executive Health Check Up (Male)</h2>
