...
export const metadata: Metadata = {
  ...
  description:
    "Detailed information and items covered under the Executive Health Check Up (Female).",
  alternates: {
    canonical: "https://popularhospital.in/services/wellness-packages/executive-health-check-up-female",
  },
};
