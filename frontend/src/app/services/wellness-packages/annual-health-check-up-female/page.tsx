...
export async function generateMetadata() {
  return generatePageMetadata("/services/wellness-packages/annual-health-check-up-female", {
  title:
    "Annual Health Check Up (Female) | Wellness Packages | Popular Hospital",
  description:
    "Detailed information and items covered under the Annual Health Check Up (Female).",
  alternates: {
    canonical: "https://www.popularhospital.in/services/wellness-packages/annual-health-check-up-female",
  },
});
}
