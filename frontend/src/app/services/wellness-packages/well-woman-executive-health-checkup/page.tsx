...
export const metadata: Metadata = {
  title: 'Well Woman Executive Health Checkup | Wellness Packages | Popular Hospital',
  description: 'Detailed information and items covered under the Well Woman Executive Health Checkup.',
};

export default function PackagePage() {
  const investigations = [
    'Complete Haemogram -CBC & ESR', 'Blood Group', 'Serum Creatinine', 'Lipid Profile', 'Blood Sugar Fasting', 'TSH', 'T3', 'SGPT', 'SGOT', 'PAP Smear (For Females)', 'X-Ray Chest', 'Ultrasound whole abdomen', 'X-Ray Mammography (for females)', 'ECG', 'Physician Consultation', 'Gynaecologist Consultation', 'Dental Consultation', 'Dietician Consultation'
  ];
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[250px] md:h-[300px] w-full bg-[#1a2b3c] overflow-hidden flex items-center">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/wellness_packages/gold-women.jpg"
            alt="Well Woman Executive Health Checkup"
            fill
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1366px] px-6">
          <div className="max-w-4xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4 font-heading tracking-tight">
              Well Woman Executive Health Checkup
            </h1>
            <nav className="flex items-center text-sm md:text-base text-white/90 font-medium" aria-label="Breadcrumb">
              ...
              <span className="mx-2 text-red-600 font-bold">|</span>
              <span className="text-white">Well Woman Executive Health Checkup</span>
            </nav>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-20">
            <div className="w-full md:w-[70%] bg-white rounded-[32px] shadow-[0_8px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex overflow-hidden group">
                ...
                <div className="p-10 flex flex-col justify-center flex-1">
                    <h2 className='text-[#1d1d1f] font-bold text-xl sm:text-2xl tracking-tight mb-4 uppercase'>Well Woman Executive Health Checkup</h2>
