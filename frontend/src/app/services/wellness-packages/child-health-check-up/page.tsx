...
export async function generateMetadata() {
  return generatePageMetadata("/services/wellness-packages/child-health-check-up", {
  title:
    "Child Health Check UP (10-18 Yrs) | Wellness Packages | Popular Hospital",
  description:
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 mb-20">
            <div className="w-full md:w-[70%] bg-white rounded-[32px] shadow-[0_8px_40px_rgba(0,0,0,0.06)] border border-gray-100 flex overflow-hidden group">
              <div className="w-[160px] sm:w-[220px] relative bg-[#f5f5f7] flex-shrink-0">
                <Image
                  src="/images/wellness_packages/healthy-young-one.jpg"
