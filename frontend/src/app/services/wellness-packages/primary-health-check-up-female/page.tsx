...
export async function generateMetadata() {
  return generatePageMetadata("/services/wellness-packages/primary-health-check-up-female", {
  title:
    "Primary Health Check Up (Female) | Wellness Packages | Popular Hospital",
  description:
