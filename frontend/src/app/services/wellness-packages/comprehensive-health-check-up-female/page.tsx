...
export async function generateMetadata() {
  return generatePageMetadata("/services/wellness-packages/comprehensive-health-check-up-female", {
  title:
    "Comprehensive Health Check Up (Female) | Wellness Packages | Popular Hospital",
  description:
    "Detailed information and items covered under the Comprehensive Health Check Up (Female).",
  alternates: {
    canonical: "https://www.popularhospital.in/services/wellness-packages/comprehensive-health-check-up-female",
  },
});
}
...
export default function PackagePage() {
  const investigations = [
    ...
    "X-Ray Chest",
    "Ultrasound whole abdomen & Breast",
    "PFT",
    "2D-ECHO",
    "CPK",
            ...
            <div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {investigations.map((item, id) => (
                  <div
                    key={id}
                    className="bg-white border border-gray-100/80 p-5 rounded-2xl text-[14px] text-[#1d1d1f] font-medium uppercase shadow-sm flex items-center gap-4 group/item hover:border-orange-100 transition-colors"
                  >
