...
export const metadata: Metadata = {
  ...
  description: '24 hrs Ambulance pickup service available all the way from anywhere in Varanasi ensuring fast and prompt transport to our Emergency Team.',
};
    ...
    content: (
      <>
        ...
        <h3 className="text-xl font-bold mb-3 text-blue-800 mt-6 md:mt-8">
          Also you may need the ambulance in Varanasi. Will the ambulance travel all the way from popular hospital to such distant places?
        </h3>
        <p className="mb-4 text-gray-600 leading-relaxed text-sm lg:text-base text-justify">
          A lot of time will be lost. Then... With Popular Hospital it is different. The nearest Ambulance available in your locality will be rushed to your place, wherever you are to bring your patient directly to Popular Hospital in the shortest possible time. And while the patient is on the way the Emergency Team at Popular Hospital will make ready the ICU Bed, O.T. etc. So that little time is lost reaches Popular Hospital. No other hospital in Varanasi offers 24 hrs. Ambulance pickup service, not even during daytime.
        </p>
      </>
    ),
    image: 'https://images.unsplash.com/photo-1587556930799-8daca6a1bb5d?auto=format&fit=crop&q=80&w=1200',
    ...
    content: (
      <ul className="text-gray-600 leading-relaxed text-sm lg:text-base text-justify">
        <li className="flex gap-4">
             ...
             <span>For excellence in quality of routine and super specialty pathology testing Popular Hospital Pathology lab has also received the prestigious accreditation from the National Accreditation Board for Laboratories (NABL). In Eastern India only Popular Hospital pathology lab has in-house facilities to perform super specialty pathology tests like PCR, Flow Cytometry, etc. This benefits Popular Hospitals patients tremendously and there is practically no waiting time for getting test results when compared to other hospitals in Varanasi who have to send these tests to Mumbai or Delhi and wait for 3 / 4 days for got test results. Thus there is no delay in diagnosis and therefore, prompt and accurate treatment for Popular Hospital's patients.</span>
        </li>
      </ul>
    ),
  ...
  },
  {
    ...
    content: (
       <ul className="text-gray-600 leading-relaxed text-sm lg:text-base text-justify">
        <li className="flex gap-4">
             <span className="text-blue-500 font-bold mt-1">›</span>
             <span>2 of the major fears any surgeon has before any operation is that of OT infection and cardiac. heart complications during or after the operation. If OT infections occur or the patient develops cardiac problems even the best surgeon cannot help you. Popular Hospital is the only hospital in Varanasi having STEEL OPERATION THEATERS (Steel OTs) which drastically reduces chances of OT infection. After the surgery the patient is under the best care of doctors and nurses in the post-operative phase at Popular Hospital.</span>
        </li>
      </ul>
    ),
  ...
  },
  {
    ...
    content: (
       <ul className="text-gray-600 leading-relaxed text-sm lg:text-base text-justify">
        <li className="flex gap-4">
             <span className="text-blue-500 font-bold mt-1">›</span>
             <span>With 28 medical departments having in-house specialist doctors any problem during your stay at Popular Hospital can be handled by this specialist doctors' team 24 hours. You may be admitted for a particular surgery but in the event there are some problems which a specialist needs doctor of another department it is available immediately in-house at Popular Hospital. This facility is often not available at other renowned hospitals.</span>
        </li>
      </ul>
    ),
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1366px] px-6">
          <div className="animate-fade-in-up max-w-4xl">
            ...
            <nav className="flex items-center text-sm md:text-lg text-white/90 font-bold" aria-label="Breadcrumb">
              ...
              <span className="mx-3 text-red-500 font-black">/</span>
              <span className="text-white uppercase tracking-wider">Ambulance</span>
            </nav>
          </div>
        </div>
      </section>
