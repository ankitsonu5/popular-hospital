...
import { Search, FileText, Phone, Mail, AlertCircle, ArrowRight } from 'lucide-react';
...
export default function PatientReportsPage() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      alert('Report searching functionality will be integrated with the hospital HMS system.');
    }, 1500);
  };
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1366px] px-6">
          <div className="max-w-3xl">
            ...
            <p className="text-white/70 text-base md:text-lg font-medium max-w-xl">
              Quickly find and download your medical reports using your Bill ID or Registration Number.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white rounded-[40px] shadow-[0_20px_60px_-15px_rgba(30,58,95,0.1)] border border-gray-100 overflow-hidden">
            <div className="flex flex-col md:flex-row min-h-[400px]">
              ...
              <div className="md:w-2/5 relative h-64 md:h-auto overflow-hidden">
                ...
                <div className="absolute bottom-8 left-8 text-white z-10 hidden md:block">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="font-bold tracking-wide uppercase text-sm">SECURE ACCESS</span>
                  </div>
              ...
              <div className="flex-1 p-8 md:p-14 flex flex-col justify-center">
                <div className="mb-10">
                  <h2 className="text-2xl font-black text-[#1e3a5f] mb-2 uppercase tracking-tight">Search Your Report</h2>
                ...
                <div className="bg-gray-50 p-1.5 rounded-2xl inline-flex w-fit mb-8 border border-gray-100">
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-xl text-sm font-bold transition-all ${
                      searchMethod === 'bill' ? 'bg-white text-[#1e3a5f] shadow-sm' : 'text-gray-400 hover:text-gray-600'
                    }`}
                  >
                    Bill ID
                  </button>
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-xl text-sm font-bold transition-all ${
                      searchMethod === 'reg' ? 'bg-white text-[#1e3a5f] shadow-sm' : 'text-gray-400 hover:text-gray-600'
                    }`}
                  >
                    Reg. No
                  </button>
                ...
                <form onSubmit={handleSearch} className="space-y-6">
                  <div className="relative group">
                    <input
                      ...
                      placeholder={searchMethod === 'bill' ? "Enter Bill ID (e.g. PHV25-123)" : "Enter Reg. No (e.g. REG-456)"}
                ...
                <div className="mt-8 flex items-center gap-3 text-orange-600/80 font-bold bg-orange-50/50 p-4 rounded-xl border border-orange-100/50">
                  ...
                  <p className="text-xs">Note: Reports may take 24-48 hours to appear online.</p>
                </div>
              </div>
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm flex items-center justify-between group hover:border-[#0d9488]/30 transition-all">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h3 className="text-lg font-black text-[#1e3a5f] uppercase tracking-tight">Need Help?</h3>
                  <div className="flex flex-col text-sm font-bold text-gray-500">
                    <a href="tel:+917800001895" className="hover:text-[#0d9488] transition-colors">+91-7800001895</a>
                    <a href="tel:+917800001896" className="hover:text-[#0d9488] transition-colors">+91-7800001896</a>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm flex items-center justify-between group hover:border-[#0d9488]/30 transition-all">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h3 className="text-lg font-black text-[#1e3a5f] uppercase tracking-tight">Email Us</h3>
                  <a href="mailto:info@popularhospitals.in" className="text-sm font-bold text-gray-500 hover:text-[#0d9488] transition-colors block">
