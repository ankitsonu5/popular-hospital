    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="relative h-[250px] md:h-[300px] bg-gray-900 overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1556742044-3c52d6e88c62?q=80&w=1600&auto=format&fit=crop")' }}
        />
      ...
      <main className="flex-grow py-12 md:py-16">
        <div className="max-w-[1366px] mx-auto px-6">
          <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-bold text-hospital-teal mb-4">Payment Gateway & Methods</h2>
              <div className="space-y-4">
                ...
                <ul className="space-y-2 list-none marker:text-hospital-teal">
                  <li className="flex gap-3">
                    ...
                    <span>Visa, MasterCard, Maestro, and Amex credit cards</span>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-hospital-teal font-bold">&gt;</span>
            ...
            <section>
              <h2 className="text-2xl font-bold text-hospital-teal mb-4">Responsibility of the User</h2>
              <div className="space-y-4">
                <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-hospital-teal mb-4">Confirmation and Evidence of Transaction</h2>
              <div className="space-y-4">
                <p>
                  <strong className="text-gray-900">Non-Paid Appointments:</strong> After booking, you will receive an SMS confirmation on the registered mobile number. This must be shown at the billing counter to receive a printed invoice.
                </p>
                <p>
                  <strong className="text-gray-900">Paid Appointments:</strong> SMS confirmation of booking and payment is sent to the registered mobile number. Invoices are generated upon arrival at the billing counter. Printed duplicate copies of invoices can also be requested at the counter if needed.
                </p>
                <p>
