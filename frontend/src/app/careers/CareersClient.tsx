      ...
      <div className="max-w-[1366px] mx-auto px-6 lg:px-12">
        ...
        <div className="mt-28">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black text-[#1a3a5c] mb-4 font-heading tracking-tight uppercase tracking-widest">
              Why Join Us?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div
                key={i}
                className="bg-white p-10 rounded-[3rem] shadow-sm border border-slate-50 hover:-translate-y-2 transition-transform duration-500 text-center"
              >
                <div className="w-16 h-16 bg-slate-50 rounded-2xl flex items-center justify-center mx-auto mb-8 text-[#E85222] shadow-inner">
                  {benefit.icon}
                </div>
                <h3 className="text-xl font-black mb-4 text-[#1a3a5c] leading-tight">
                  {benefit.title}
                </h3>
        ...
        <div className="mt-28 bg-[#1a3a5c] rounded-[3rem] p-12 text-center text-white relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            <h3 className="text-3xl font-black mb-6 font-heading tracking-widest uppercase">
              Can't find a matching role?
            </h3>
            <p className="text-gray-300 text-lg mb-10 max-w-2xl mx-auto font-medium italic">
              ...
              family. Drop your CV, and we will get back to you if a suitable
              position opens up."
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Link
                href="mailto:careers@popularhospital.in"
                className="px-12 py-5 bg-[#E85222] text-white rounded-2xl font-black hover:bg-[#d1451a] transition-all shadow-xl shadow-orange-900/30 uppercase tracking-[0.2em] text-sm"
              >
                Send your CV
              </Link>
              <a
                href="tel:+917800001895"
                className="px-12 py-5 bg-white/10 backdrop-blur-md text-white border border-white/20 rounded-2xl font-black hover:bg-white/20 transition-all uppercase tracking-[0.2em] text-sm"
              >
                HR Helpline
              </a>
            </div>
