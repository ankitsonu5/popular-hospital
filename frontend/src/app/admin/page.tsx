    ...
    return (
      <div className="rounded-xl bg-white p-8 shadow-sm">
        ...
        <p className="mt-2 text-gray-600">
          You are logged in. Manage website content below.
        </p>
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <Link
            href="/admin/branches"
            className="rounded-lg border border-gray-200 p-4 hover:border-hospital-teal hover:bg-gray-50"
          >
            <span className="font-medium">Branches</span>
            <p className="text-sm text-gray-500">
              Add and edit hospital branches
            </p>
          </Link>
          <Link
            href="/admin/doctors"
  ...
  return (
    <div className="mx-auto max-w-md rounded-xl bg-white p-8 shadow-sm">
      ...
      <p className="mt-2 text-sm text-gray-600">
        Enter your CMS key to manage the website. (Dev key:
        popular-hospital-cms-dev)
      </p>
