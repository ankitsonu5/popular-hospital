...
import { Plus, Pencil, Trash2, Search, Loader2, Building2, MapPin, Clock, Phone, GripVertical, Image as ImageIcon } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
          {filteredBranches.map((branch, index) => (
            ...
            >
              ...
              <div className="h-40 bg-gray-100 relative overflow-hidden">
                <img src={getImageUrl(branch.image_one)} alt={branch.name} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
              ...
              <div className="p-5">
                <div className="flex items-start justify-between mb-3">
                  <div className="min-w-0">
                    <h3 className="font-bold text-gray-900 text-base line-clamp-1">{branch.name}</h3>
          ...
          {filteredBranches.length === 0 && (
            <div className="col-span-full text-center py-16 text-gray-400 bg-white rounded-2xl border-2 border-dashed border-gray-100">
               ...
               <p className="font-semibold text-sm">No branches found in results.</p>
            </div>
          )}
        </div>
      )}
