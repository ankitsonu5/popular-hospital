            ...
            <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-200 shadow-sm">
                <div className="max-w-[1366px] mx-auto px-4 sm:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <div className="flex items-center gap-4 w-full sm:w-auto">
                        <Link href="/admin-dashboard/branches" className="p-2 hover:bg-gray-100 rounded-lg transition-colors text-gray-500">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="text-xs text-gray-500 font-medium tracking-tight">Location Node • Popular Hospital</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto">
                        ...
                        <button onClick={handleSubmit} disabled={isSaving} className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-8 py-2.5 bg-[#0d9488] hover:bg-[#0b7a6f] text-white rounded-lg shadow-md hover:shadow-lg transition-all font-semibold text-sm disabled:opacity-50">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-8 space-y-8">
                        ...
                        <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-sm border border-gray-200">
                            ...
                            <div className="space-y-2">
                                <label className="block text-sm font-semibold text-gray-700">Branch Description</label>
                        ...
                        <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-sm border border-gray-200">
                            ...
                            <div className="space-y-2 mb-6">
                                <label className="block text-sm font-semibold text-gray-700">HQ Address *</label>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div className="space-y-2">
                                    <label className="block text-sm font-semibold text-gray-700">Operational Hours</label>
                        ...
                        <div className="bg-white p-8 sm:p-10 rounded-2xl shadow-sm border border-gray-200">
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                <div className="space-y-2">
                                    <label className="block text-sm font-semibold text-gray-700">Google Map Embed (Iframe Src)</label>
                                ...
                                <div className="space-y-2">
                                    <label className="block text-sm font-semibold text-gray-700">Direct Directions Link</label>
                    ...
                    <div className="lg:col-span-4 space-y-8">
                                        ...
                                        <label htmlFor={`upload-${key}`} className="block relative aspect-square rounded-xl bg-gray-50 border-2 border-dashed border-gray-200 hover:border-[#0d9488] cursor-pointer overflow-hidden transition-all group shadow-inner">
                                            {previews[key] ? (
                                                ...
                                                <div className="absolute inset-0 flex flex-col items-center justify-center gap-1 text-gray-300">
                                                    ...
                                                    <span className="text-[9px] font-bold uppercase tracking-wider">{key.split('_')[1]}</span>
                                                </div>
                                            )}
                                        </label>
                                    </div>
                        ...
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200">
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <label className="block text-sm font-semibold text-gray-700">Specialized Facilities</label>
                        ...
                        {/* Status Hub */}
                        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200">
                            <h2 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-6">Operational Node</h2>
                            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl mb-4">
                                <div className="flex flex-col">
                                    <span className="text-sm font-bold text-gray-700">Status</span>
                                    <span className="text-[10px] text-gray-400 font-medium">Toggle visibility</span>
                                </div>
                            ...
                            <p className="text-[10px] text-gray-400 leading-relaxed font-medium">When active, this branch details will be visible in the locations section of the site.</p>
                        </div>
                    </div>
                </form>
            </div>
