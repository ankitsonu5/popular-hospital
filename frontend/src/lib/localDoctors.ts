...
export const localDoctors: Record<string, LocalDoctorDetail> = {
  ...
  'dr-kamlesh-kumar-singh': {
    ...
    qualifications: 'MBBS (Gandhi Medical College, Bhopal), MS - General Surgery (Government Medical College, Patiala - 2016), MCh - Neurosurgery (Kasturba Medical College, Manipal - 2020)',
    designation: 'Consultant',
