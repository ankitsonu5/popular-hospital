  ...
  if (!doctors || doctors.length === 0) {
    return (
      <div className="bg-white rounded-xl shadow border border-gray-100 p-12 text-center max-w-sm mx-auto">
        ...
        <p className="text-gray-500 font-bold text-lg">Information Not Available</p>
        <p className="text-gray-400 text-sm mt-1">We are currently updating our doctor profiles for this department.</p>
      </div>
    );
  }
