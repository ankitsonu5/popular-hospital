...
export default function MobileBottomNav() {
  ...
  return (
    <div
      className="md:hidden fixed bottom-0 left-0 right-0 z-[100] bg-white border-t border-gray-200 shadow-[0_-4px_20px_rgba(0,0,0,0.06)] pb-safe-bottom"
      ...
      <div className="flex justify-between items-center px-2 py-2">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <Icon
                className={`w-5 h-5 flex-shrink-0 ${isActive ? "stroke-[2.5px]" : "stroke-[1.5px]"}`}
              />
              {isActive && (
