...
export default function RadiologyVideoSection() {
  return (
    <div className="relative rounded-2xl overflow-hidden shadow-2xl h-[400px] lg:h-[500px] group bg-black">
      <Image
        src="https://images.unsplash.com/photo-1551076805-e1869033e561?q=80&w=2664&auto=format&fit=crop"
        alt="Radiology Procedure"
        fill
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative">
          <div className="w-20 h-20 bg-[#F05A28] rounded-full flex items-center justify-center shadow-lg relative z-10 text-white/90">
            <svg
