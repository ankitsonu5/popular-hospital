...
export function Footer() {
  return (
    <footer className="bg-[#0b1c43]">
      <div className="bg-[#0b1c43] text-white rounded-t-[2.5rem] px-6 py-12 sm:px-10 sm:py-16 md:px-16 lg:py-20 mx-auto max-w-[1920px]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          ...
          {/* Column 5: Trust & Legal + Social */}
          <div className="flex flex-col h-full">
            <div>
              <h3 className="text-lg font-bold font-heading mb-6">Trust & Legal</h3>
              <ul className="space-y-3 text-sm text-gray-200 mb-8">
                <li><Link href="/terms" className="hover:text-white transition-colors">Terms & Conditions</Link></li>
                <li><Link href="/privacy" className="hover:text-white transition-colors">Privacy Policy</Link></li>
                <li><Link href="/hospital-stay" className="hover:text-white transition-colors">Hospital Stay</Link></li>
              </ul>
            </div>
