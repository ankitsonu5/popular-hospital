...
export const createContact = async (req, res) => {
  try {
    const { name, email, phone, date, timing, department, location, message, agreedToTerms, age, country, isInternational } = req.body;
    ...
    res.status(201).json({ id: contact._id, message: 'Your appointment request has been submitted successfully!' });
  } catch (error) {
